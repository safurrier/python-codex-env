...
class DummyGitHubApp:
    def installation_client(self, installation_id: int):  # pragma: no cover
        raise RuntimeError("installation_client should be stubbed in tests")
...
def test_issue_comment_triggers_job_and_comment() -> None:
    async def run() -> None:
        ...
        handler = WebhookHandler(
            ...
            agent_runner=runner,
            github_client_factory=lambda installation_id: github,
        )
        payload = {
